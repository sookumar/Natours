...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  // 4) Check if user changed password after jwt token was issue
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  try {
    ...
    return next(
      new AppError('There was an error sending the eamil. Try again later'),
      500,
    );
  }
});
...
exports.updatePassword = catchAsync(async (req, res, next) => {
  ...
  user.passwordConfirm = req.body.passwordConfirm;
  await user.save();
  // User.FindbyIdandUpdate not work here as intended
